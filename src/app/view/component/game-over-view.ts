...
export class GameOverView extends View {
  ...
  public init() {
    ...
    this._graphics.drawRect(0, - window.innerHeight / 2, this.size.width, window.innerHeight * 2);
    this._graphics.interactive = true;
    this.addChild(this._graphics);

    this._gameOverText = new PIXI.Text('Game Over', titleStyle)
    this._gameOverText.x = (this.size.width - this._gameOverText.width) / 2;
    this._gameOverText.y = (this.size.height - this._gameOverText.height) / 2;
